\setpart{Introduction}
	...
	\setsection{Origines}
		...
		Afin de comprendre les \glspl{rainbow} et leurs avantages par rapport à d'autres méthodes, nous allons commencer par expliquer le principe du \gls{TMTO} en partie 2. Puis dans la partie 3 nous présenterons les \glspl{rainbow} en les comparant à la méthode des points distincts. Nous détaillerons ensuite cette méthode des points distincts en partie 4. Enfin, nous verrons une amélioration notable de ces tables, dans la partie 5, avant de conclure en partie 6.
