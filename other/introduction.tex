\setsection{Introduction}
	...
	\setsubsection{Historique}
		...
		21 ans après, Oechslin\cite{Oech03} propose une autre amélioration du compromis temps-mémoire, différente de celle de Rivest, les tables arc-en-ciel. Deux ans plus tard, Gildas Avoine, Pascal Junod et Philippe Oechslin\cite{checkpoints} proposent une avancée pour le compromis, l'ajout de points de contrôles (points utilisables aussi avec les points distincts ou les tables arc-en-ciel).

		\bigskip

		Enfin, en 2006, Elad Barkan propose une variante aux tables ac-en-ciel\cite{fuzzy}, les tables arc-en-ciel floues. Puis en 2008, Jin Hong, Kyung Jeong, Eun Kwon, In-Sok Lee, et Daegun Ma proposent une variantes à la méthode des points distincts. Depuis ces variante, aucune avancée majeure n'a été publiée sur ce sujet.
