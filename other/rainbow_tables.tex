\setsection{Rainbow Tables}
	...
	Les chances que deux chaînes fusionnent étaient de 1 avec la méthode classique, avec les chaînes arc-en-ciel les chances de fusion sont de $\frac{1}{t}$. Le succès pour une table de taille $m*t$ :
	...
	Ces tables offres les mêmes avantages que les tables classiques avec point finaux caractéristiques sans certains inconvénients :
	\bi
