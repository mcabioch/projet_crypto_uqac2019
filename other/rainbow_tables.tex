\setsection{Tables arc-en-ciel}

	\setsubsection{Comparaison et avantages}
		...
		\bi
			...
			\item Les \glspl{rainbow} ont une taille constante tandis que les chaînes à point distincts ont une taille variable. Ce qui réduit considérablement les fausses alertes.
		\ei

	\setsubsection{Expérimentations}
	...
	\setsubsection{Pistes d'améliorations}
