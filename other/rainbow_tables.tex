\setsection{Rainbow Tables}
	...
	Le problème des précédentes tables est que si deux chaînes entrent en collision, elles fusionnent. Il existe des méthodes pour que deux chaînes en collision ne fusionnent pas, les \glsp{rainbow}. Le principe : elles utilisent des fonctions de réductions différentes à chaque point de la chaîne.

	Les chances que deux chaînes fusionnent étaient de 1 avec la méthode classique\cite{Oech03}, avec les \glsp{rainbow} les chances de fusion sont de $\frac{1}{t}$. Le succès pour une table de taille $m*t$ :
	...
	\bi
		...
		\item Les \glsp{rainbow} ont une taille constante tandis que les chaînes à point caractéristiques ont une taille variable. Ce qui réduit considérablement les fausses alertes.
	\ei
