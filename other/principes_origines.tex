...
%	Nous pouvons noté que assez rapidement une amélioration a été proposé par Rivest \cite{Rivest}, cette amélioration consiste de fixer un critère d'arrêt au lieu de générer des chaînes de taille fixe. Ainsi lors de la phase de recherche de l'inverse d'un cyphertext, nous n'avon
