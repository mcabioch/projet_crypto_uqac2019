...
\setsubsection{Première Variante}
	...
	\begin{owntab}{l|c|c|c|c}
		& \multicolumn{1}{l|}{nombre}	& \multicolumn{1}{l|}{nombre de}	& \multicolumn{1}{l|}{nombre}			& \multicolumn{1}{l|}{équation}		\\
		& \multicolumn{1}{l|}{d'entrée}	& \multicolumn{1}{l|}{recherche}	& \multicolumn{1}{l|}{d'évaluations}	& \multicolumn{1}{l|}{de la courbe}	\\
		& \multicolumn{1}{l|}{par table}	& \multicolumn{1}{l|}{dans la}	& \multicolumn{1}{l|}{de fonction}		& \multicolumn{1}{l|}{de compromis}	\\
		& \multicolumn{1}{l|}{(M)}		& \multicolumn{1}{l|}{table}		& 										& 									\\\hline
